...
def lsape_multiset_cost(layer_g,layer_h,attribute,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph): 
...
def compute_layer_distance(layer_g, layer_h,alpha,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph):
    ...
    node_cost = lsape_multiset_cost(layer_g,layer_h,0,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    outer_edge_cost = lsape_multiset_cost(layer_g,layer_h,1,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    inner_edge_cost = lsape_multiset_cost(layer_g,layer_h,2,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    node_cost /= max_node
...
def substitution_cost(ring_g_node,ring_h_node,alpha,level,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph):
    if len(ring_g_node) > level and  len(ring_h_node) > level : 
        return compute_layer_distance(ring_g_node[level],ring_h_node[level],alpha,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    return 0
...
def deletion_cost(ring_g_node,alpha,level,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph):
    if len(ring_g_node) > level : 
        return compute_layer_distance(ring_g_node[level],None,alpha,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    return 0

def insertion_cost(ring_h_node,alpha,level,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph):
    if len(ring_h_node) > level : 
        return compute_layer_distance(None,ring_h_node[level],alpha,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph)
    return 0

def compute_ring_distance(g,h,ring_g,ring_h,g_node_index,h_node_index,alpha,lbda,node_costs,nodeInsDel,edge_costs,edgeInsDel,first_graph,second_graph):
    red = 0
    #print('lbda : ', lbda)
