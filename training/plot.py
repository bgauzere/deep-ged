...
print(os.path.exists('../pickle_files/'+rings_andor_fw))
print(os.path.exists('../pickle_files/'+rings_andor_fw+'/InsDel'))

InsDel = torch.load('../pickle_files/' + rings_andor_fw + '/InsDel', map_location=torch.device('cpu'),
                         pickle_module=pkl)
nodeSub = torch.load('../pickle_files/' + rings_andor_fw + '/nodeSub', map_location=torch.device('cpu'),
                        pickle_module=pkl)
edgeSub = torch.load('../pickle_files/' + rings_andor_fw + '/edgeSub', map_location=torch.device('cpu'),
                         pickle_module=pkl)
loss_plt = torch.load('../pickle_files/' + rings_andor_fw + '/loss_plt', map_location=torch.device('cpu'),
                        pickle_module=pkl)

loss_valid_plt = torch.load('../pickle_files/' + rings_andor_fw + '/loss_valid_plt', map_location=torch.device('cpu'),
                        pickle_module=pkl)
